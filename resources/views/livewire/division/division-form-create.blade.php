    ...
    <x-forms.forms-section  submit="{{$mode === 'edit' ? 'update' : 'store'}}">
        ...
        <x-slot name="form">
            ...
            <div class="mb-4">
                 ...
                 <livewire:components.addresses-search :addresses="$division['addresses'] ?? []" :class="'grid grid-cols-4 gap-6'" />
             </div>
            <div x-data="{ working: false }" class="mb-4">
                <div class="py-4">
                <h3 class="font-medium text-2xl	 text-black dark:text-white">{{__('Графік роботи')}}
