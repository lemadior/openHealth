...
{{--                @include('livewire.employee._parts._positions')--}}
    ...
    @endif
    @if($error['status'])
        <div id="errorMessage" x-data="{ isVisible: true }" class="flex fixed  bottom-[1.5rem] w-2/6  right-2 border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
