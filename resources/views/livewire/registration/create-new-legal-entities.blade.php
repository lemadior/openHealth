    ...
    <div class="steps bg-white pt-10 pb-10 flex flex-center">
        <ol class="items-center justify-center	 w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse">
            @foreach($steps as $key=>$step)
                <li  wire:click="changeStep({{$step['step']}},'{{$step['property']}}')" class="cursor-pointer flex items-center {{$step['step'] == $currentStep ? 'border-primary' : ''}} text-primary-500 space-x-2.5 rtl:space-x-reverse">
            <span
